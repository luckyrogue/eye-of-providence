...
func subscriptionActivatedBaseline(loc Locale) *Template {
	...
	copies := map[Locale]sub{
		LocaleRU: {
			...
			valid:    "Если есть вопросы — пиши на main@rysdavletov.org.",
		...
		LocaleEN: {
			...
			button:   "Open billing",
			valid:    "Questions? Reach us at main@rysdavletov.org.",
		...
		LocaleKK: {
			...
			valid:    "Сұрақтар болса — main@rysdavletov.org.",
		...
		LocaleES: {
			...
			valid:    "¿Preguntas? Escríbenos a main@rysdavletov.org.",
