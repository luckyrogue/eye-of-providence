    ...
    <div className="w-80 p-4 space-y-3">
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          {token ? (
            <>
              <div className="text-xs text-muted-foreground">Подключено к eop.rysdavletov.org.</div>
            ...
            <>
              <div className="text-xs text-muted-foreground">
                Dev login (без OAuth). Backend по умолчанию: <code>eop.rysdavletov.org</code>.
              </div>
